                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="product-pic-zoom">
                                <!-- Bisa menggunakan syntax vue -> v-bind (:dots, :autoplay) -->
...
export default {
  ...
  data() { // data atau apa saja yang akan di tampilkan di halamin ini baik di local maupun dari API
    return {
  ...
  methods: { // Wadah untuk membungkus fungsi
      changeImage(urlImage) { // Fungsi
